...
const InputField: FC<InputProps> = ({
  ...
  if (disabled) {
    ...
    inputClasses +=
      " bg-transparent border-gray-300 text-gray-800 focus:border-brand-300 focus:ring-brand-500/20 dark:border-gray-700 dark:text-white/90 dark:focus:border-brand-800";
  }
